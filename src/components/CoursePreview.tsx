...
const CoursePreview: React.FC<CoursePreviewProps> = ({
    ...
    function handleCreateCourse() {
        ...
        if (type === 'Video & Text Course') {
            ...
            const prompt = `Strictly in ${lang}, Explain me about this subtopic of ${courseName} with examples :- ${firstSubtopic.title}. Please Strictly Don't Give Additional Resources And Images.  Do not include phrases such as "Okay", "Sure", or "I'll explain". Start directly with the explanation. Write in a professional, documentation style.`;
    ...
    async function sendTranscript(url, subtopic) {
        ...
        try {
            ...
            try {
                ...
                const prompt = `Strictly in ${lang}, Summarize this theory in a teaching way and :- ${concatenatedText}.  Do not include phrases such as "Okay", "Sure", or "I'll explain". Start directly with the explanation. Write in a professional, documentation style.`;
                sendSummery(prompt, url);
            } catch (error) {
                const prompt = `Strictly in ${lang}, Explain me about this subtopic of ${courseName} with examples :- ${subtopic}. Please Strictly Don't Give Additional Resources And Images.  Do not include phrases such as "Okay", "Sure", or "I'll explain". Start directly with the explanation. Write in a professional, documentation style.`;
                sendSummery(prompt, url);
            }
