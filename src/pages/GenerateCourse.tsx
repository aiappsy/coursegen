      ...
      <div className="space-y-8 animate-fade-in max-w-3xl mx-auto px-4 py-8">
        ...
        {isMobile ? (
          <Sheet open={isGoPaidDialog} onOpenChange={setGoPaidDialog}>
            <SheetContent side="bottom" className="h-[50vh] sm:max-w-full p-0">
              <motion.div
              ...
              >
                {/* Gradient Header */}
                <div className="bg-gradient-to-br from-primary via-indigo-600 to-indigo-500 p-6 text-white">
                  <div className="flex items-center gap-2">
                    <Sparkles className="h-5 w-5" />
                    <span className="text-sm font-medium uppercase tracking-wide">Premium</span>
                  </div>
                  <h2 className="mt-3 text-2xl font-bold">Go Premium</h2>
                  <p className="mt-1 text-sm opacity-90">
                    Access all features with a Premium upgrade.
                  </p>
                </div>
                ...
                <div className="p-6 space-y-4">
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>✨ Create Unlimited Course</li>
                    <li>🚀 Video & Theory Course</li>
                    <li>🔒 Course In 23+ Languages</li>
                    <li>💎 Ai Teacher Chat</li>
                  </ul>


                  <div className="flex gap-3 pt-2">
                    <Button onClick={() => navigate('/dashboard/pricing')} className="flex-1 bg-primary">Upgrade Now</Button>
                    <Button onClick={() => setGoPaidDialog(false)} variant="outline" className="flex-1">
                      Maybe Later
                    </Button>
                  </div>
                </div>
          ...
          <Dialog open={isGoPaidDialog} onOpenChange={setGoPaidDialog}>
